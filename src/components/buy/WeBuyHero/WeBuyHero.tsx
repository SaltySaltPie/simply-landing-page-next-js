...
import { CF_CDN_URL_WE } from "@/utils/CF_CDN_URL_WE";
   ...
   <div className={`${styles.contentC}`}>
         ...
         <div className={`${styles.heading}`}>
            <div className={`${styles.content}`}>
               <div className={`${styles.description}`}>
                  <div>
                     <h1>Because selling as-is&nbsp;</h1>
                     <h1>should be simple.</h1>
                  </div>
                  <Text type="f1-125">
            ...
            <div className={`${styles.background}`}>
               <Image src={CF_CDN_URL_WE("/buy/hero/webuy-hero-banner.png")} alt="" fill sizes="100vw" />
            </div>
         </div>
      </div>
      ...
      <div className={`${styles.desC}`}>
         ...
         <div className={`${styles.des}`}>
            ...
            <Text type="f1-125">
               We strive to make your home-selling process as straightforward as possible, prioritizing your needs and
               convenience from initial contact to closing.
               <b>With no showings, cleaning, or repairs required, we offer a fair and competitive price</b> tailored to
               your unique circumstances and timeline.
            </Text>
         </div>
         <div className={`${styles.des}`}>
